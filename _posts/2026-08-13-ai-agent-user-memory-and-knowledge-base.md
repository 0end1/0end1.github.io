---
title: "AI Agent 学习笔记（四）：用户记忆与知识库—— 从四种存储格式到 RAG 检索"
date: 2026-08-13 09:00:00 +0800
categories: [AI, Agent]
tags: [AI Agent, 用户记忆, RAG, 知识库, GraphRAG]
pin: false
---
...
*本文基于李博杰著《深入理解 AI Agent：设计原理与工程实践》v1.3 第3章学习整理。系列文章同步发布于 [ai-agent-study](https://github.com/0end1/ai-agent-study) 仓库。*
